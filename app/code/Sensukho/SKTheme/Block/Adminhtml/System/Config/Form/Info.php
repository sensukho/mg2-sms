...
namespace Sensukho\SKTheme\Block\Adminhtml\System\Config\Form;
...
class Info extends \Magento\Config\Block\System\Config\Form\Field {
    ...
    public function render(\Magento\Framework\Data\Form\Element\AbstractElement $element) {
        ...
        $html = '<div style="padding:12px;background-color:#F1F1F1;border:1px solid #d1d1d1;margin-bottom:5px;font-weight: 600;">
            SKTheme: Free Responsive Theme <span style="color: #5BD77B;">v' . $m['setup_version'] . '</span> was developed by <a href="http://www.sensukho.com/" target="_blank">HiddenTechies</a>.
        </div>';

        if (in_array('curl', get_loaded_extensions())) {

            // Define the path for latest notifications
            $file = 'https://www.sensukho.com/documentation/notifications/latest_notifications.xml';
